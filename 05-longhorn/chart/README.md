...
| image.longhorn.backingImageManager.tag | string | `"v1.6.2"` | Specify Longhorn backing image manager image tag |
| image.longhorn.engine.repository | string | `"longhornio/longhorn-engine"` | Repository for the Longhorn Engine image. |
| image.longhorn.engine.tag | string | `"v1.6.2"` | Specify Longhorn engine image tag |
...
| image.longhorn.instanceManager.tag | string | `"v1.6.2"` | Specify Longhorn instance manager image tag |
| image.longhorn.manager.repository | string | `"longhornio/longhorn-manager"` | Repository for the Longhorn Manager image. |
| image.longhorn.manager.tag | string | `"v1.6.2"` | Specify Longhorn manager image tag |
...
| image.longhorn.shareManager.tag | string | `"v1.6.2"` | Specify Longhorn share manager image tag |
...
| image.longhorn.ui.tag | string | `"v1.6.2"` | Specify Longhorn ui image tag |
